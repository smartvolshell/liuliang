...
import com.liulianggu.activities.SaveDataPage;
	...
	private View createView(final String title, final String message,
		...
		okButton.setOnClickListener(new View.OnClickListener() {
			public void onClick(View view) {
				/*
				 * Intent intent; if (uri != null && uri.length() > 0 &&
				 * (uri.startsWith("http:") || uri.startsWith("https:") ||
				 * uri.startsWith("tel:") || uri .startsWith("geo:"))) { intent
				 * = new Intent(Intent.ACTION_VIEW, Uri.parse(uri)); } else {
